        ...
        parseJSON = withObject "Message" \o -> do
          ...
          case t of
            ...
            "InitDeck" -> do
              contents <-
                (Right <$> o .: "contents")
                  <|> (Left . Right <$> o .: "contents")
                  <|> (Left . Left <$> o .: "contents")
              case contents of
                Right attrs -> pure $ InitDeck attrs
                Left (Right (iid, murl, mdecklist, deck)) -> pure $ InitDeck $ InitDeckAttrs iid murl mdecklist deck
                Left (Left (iid, murl, deck)) -> pure $ InitDeck $ InitDeckAttrs iid murl Nothing deck
            "AddToVictory" -> do
