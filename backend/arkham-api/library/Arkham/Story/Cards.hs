...
engramsOath :: CardDef
engramsOath = otherSideIs "03076b" $ story "03076b" "Engram's Oath" TheLastKing
...
songsThatTheHyadesShallSing =
  otherSideIs "03325b" $ story "03325b" "Songs That the Hyades Shall Sing" DimCarcosa

starsOfAldebaran :: CardDef
starsOfAldebaran = otherSideIs "03326b" $ story "03326b" "Stars of Aldebaran" DimCarcosa

bleakDesolation :: CardDef
bleakDesolation = otherSideIs "03326d" $ story "03326d" "Bleak Desolation" DimCarcosa

inhabitantOfCarcosa :: CardDef
inhabitantOfCarcosa = otherSideIs "03327b" $ story "03327b" "Inhabitant of Carcosa" DimCarcosa

aMomentsRest :: CardDef
aMomentsRest = otherSideIs "03327d" $ story "03327d" "A Moment's Rest" DimCarcosa

theCoffin :: CardDef
theCoffin = otherSideIs "03327f" $ story "03327f" "The Coffin" DimCarcosa

mappingTheStreets :: CardDef
mappingTheStreets = otherSideIs "03328b" $ story "03328b" "Mapping the Streets" DimCarcosa

theKingsParade :: CardDef
theKingsParade = otherSideIs "03328d" $ story "03328d" "The King's Parade" DimCarcosa

theArchway :: CardDef
theArchway = otherSideIs "03328f" $ story "03328f" "The Archway" DimCarcosa

theHeightOfTheDepths :: CardDef
theHeightOfTheDepths = otherSideIs "03329b" $ story "03329b" "The Height of the Depths" DimCarcosa

stepsOfThePalace :: CardDef
stepsOfThePalace = otherSideIs "03329d" $ story "03329d" "Steps of the Palace" DimCarcosa
...
unfinishedBusiness_B =
  victory 1 $ otherSideIs "05178b" $ story "05178b" "Unfinished Business" TheWagesOfSin

unfinishedBusiness_D :: CardDef
unfinishedBusiness_D =
  victory 1 $ otherSideIs "05178d" $ story "05178d" "Unfinished Business" TheWagesOfSin

unfinishedBusiness_F :: CardDef
unfinishedBusiness_F =
  victory 1 $ otherSideIs "05178f" $ story "05178f" "Unfinished Business" TheWagesOfSin

unfinishedBusiness_H :: CardDef
unfinishedBusiness_H =
  victory 1 $ otherSideIs "05178h" $ story "05178h" "Unfinished Business" TheWagesOfSin

unfinishedBusiness_J :: CardDef
unfinishedBusiness_J =
  victory 1 $ otherSideIs "05178j" $ story "05178j" "Unfinished Business" TheWagesOfSin

unfinishedBusiness_L :: CardDef
unfinishedBusiness_L =
  victory 1 $ otherSideIs "05178l" $ story "05178l" "Unfinished Business" TheWagesOfSin
